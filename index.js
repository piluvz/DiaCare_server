      ...
      messages: [
        {
          ...
          content: [
            {
              type: "text",
              text: "У меня сахарный диабет. Помогите мне определить, какая еда или продукт находится на изображении, опиши и проанализируй все ингредиенты, и потом на основе этого скажи можно ли мне есть это при моем диабете? Стоит ли придерживаться ограничений в порции при диабете? Сколько грамм/штук/и т.д. Результат должен содержать: 1) Что изображено на картинке.  2) SAFE или NOT SAFE для диабетика. 3) Посчитай количество углеводов и выведи рекомендации по порции с количеством грамм/штук и т.д. Пожалуйста, учти мои ограничения в питании. Мне нужно строго соблюдать правила питания при диабете."
            },
            {
              type: "image_url",
              image_url: {
